program layout_demo_safe;
{$mode objfpc}{$H+}

uses SDL2, ugfx_fb, ulayout_fixed, udraw_fb;
...
var
  ...
  L: TLayout;
  i: Integer;
  vGutter, hGutter, outer: TRectI;
  COL_BG, COL_BORDER, COL_VIEW, COL_STATS, COL_MSG, COL_TEST: LongWord;

begin
  // define colors as variables (no untyped hex at call sites)
  ...
  begin
    ...
    begin
      if e.type_ = SDL_QUIT then running := False
